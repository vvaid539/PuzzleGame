...
public class Container extends Item implements CommandHandler{
	...
	/**
	 * Creates a container with the given name, description, open status, and locked status
	 * @param name the name of the container
	 * @param description the description of the container
	 ...
	 * @throws IllegalArgumentException if an item with the same name is already in the container
	 */
	...
	/**
	 * returns list containing the contents of the container. Modifying this list has no effect on the
	 * underlying list of items contained in the container because it is a different list.
	...
	/**
	 * returns the item with the given name contained in the container, or null if no such item exists.
	 * @param itemName the name of the item to return
	 * @return the item with the given name contained in the container, or null if no such item exists.
	 */
	...
	/**
	 * Adds the contents of the container to the room this container is in.
	 * This is a helper method called by the open() method.
	 */
	...
	/**
	 * Removes the contents of the container from the room the container is in.
	 * This is a helper method called by the close() method.
	 */
	...
	/**
	 * Opens the container and adds the contents to the room if it is unlocked and closed.
	...
	/**
	 * sets the room the container is in and if the container is open, this adds the contents to the room.
	 */
	@Override
	public void setRoom(Room room) {
	    super.setRoom(room);
	    if (isOpen) addContentsToRoom();
	}
