...
public abstract class Item {
	...
	/**
	 * Returns true if the name is valid (i.e. does not contain white space) and false otherwise.
	 * @param name the name to check
	 * @return true if the name is valid (i.e. does not contain white space) and false otherwise.
	 */
